...
#model.fit_generator(generated_trainingdata,samples_per_epoch=len(train_samples), validation_data=generated_validationdata, #nb_val_samples=len(validation_samples),nb_epoch=3,verbose=1)
